...
const { obtenerVentas, registrarVentas, obtenerDatosIniciales, anularVenta, anularProductoVenta, obtenerTotalVentasDelDia, obtenerTotalVentas, generarPDFVenta } = require("../controllers/ventaController");
